...
module.exports.config = {
  ...
  role: 0,
  author: "ROCKY",
  description: "Friendly AI Sizuka from Wind Breaker",
  usePrefix: true,
  guide: "[message] | just type sizuka",
  category: "ai",
  aliases: ["nobita", "mondira", "sizuka"]
};
...
const randomOpeners = [
  ...
  "new messenge dew m.me/bd.king.riyaz.top.voicer.420",
  " my owner wp number 01621251318",
  "tumi dekhte shei kala☹️",
  " tur moner pindiray ami ak konay thakte cai🌝"
];
...
module.exports.onStart = async function ({ api, args, event }) {
  ...
  try {
    ...
    api.sendMessage("❌ Sizuka confused hoye gelo!\nError: " + msg, event.threadID, event.messageID);
  }
};
